...
const guideData: Record<string, Guide> = {
  ...
  "slip-trip-fall-claims-scotland": {
    ...
    sections: [
      ...
      { heading: "Trip claims: the defect and the duty to maintain", body: "Trip claims typically involve physical defects — uneven, broken, raised or damaged surfaces. On private premises the occupier must maintain the premises to a safe standard. On public roads and pavements, the Roads (Scotland) Act 1984 places a duty on the roads authority to manage and maintain them. The Act also requires the authority to take such steps as it considers reasonable to prevent snow and ice endangering the safe passage of pedestrians and vehicles (section 34). A claim is normally made in negligence, so the pursuer must show the authority failed to take reasonable care. Unlike in England and Wales, there is no separate statutory reasonable-care defence in the Scottish Act, but inspection and repair records are still usually central." },
    ...
    sources: [
      ...
      { label: "Roads (Scotland) Act 1984 — local authority road and footway maintenance duties", href: "https://www.legislation.gov.uk/ukpga/1984/54/contents", note: "Sets the roads authority's duties to manage and maintain public roads and to take reasonable steps against snow and ice." },
      commonSources.limitation,
    ],

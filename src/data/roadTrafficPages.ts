...
export const roadTrafficPages: RoadTrafficPage[] = [
  ...
  },
  {
    ...
    sources: [{ label: "Damages (Scotland) Act 2011", href: "https://www.legislation.gov.uk/asp/2011/7/contents", note: "Primary legislation governing damages where personal injury results in death." }, { label: "SCTS: Fatal Accident Inquiries", href: "https://www.scotcourts.gov.uk/fatal-accident-inquiries/", note: "Official explanation of the FAI process." }, limitation],

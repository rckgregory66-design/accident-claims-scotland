...
const faqs = [
  ...
  { question: "Can I claim if my accident happened near Inverness?", answer: "Yes. We handle claims for people across the wider Inverness area and the surrounding region. The accident does not need to have happened in Inverness city centre — claims can arise from accidents anywhere in the area." },

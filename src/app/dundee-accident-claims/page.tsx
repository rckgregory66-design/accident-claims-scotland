...
const faqs = [
  ...
  { question: "Can I claim if my accident happened near Dundee?", answer: "Yes. We handle claims for people across the wider Dundee area and the surrounding region. The accident does not need to have happened in Dundee city centre — claims can arise from accidents anywhere in the area." },

    ...
    <ClaimPageTemplate
      ...
      sections={[
        ...
        },
        {
          ...
          linkedList: [
            ...
            { text: "Council accident claims — parks, car parks, public buildings, roads", href: "/public-place-accident-claims-scotland/council-accident-claims" },
            { text: "Shop and retail accident claims — falling goods, poor lighting, cluttered aisles", href: "/shop-accident-claims-scotland" },
            { text: "Restaurant and café accident claims — wet floors, spilled food or drink", href: "/public-place-accident-claims-scotland/restaurant-pub-and-cafe-accident-claims" },
            { text: "School accident claims — injuries to children in schools and leisure facilities", href: "/school-accident-claims-scotland" },
            { text: "Sports and leisure facility claims — gyms, swimming pools, sports centres", href: "/public-place-accident-claims-scotland/sports-and-leisure-injury-claims" },
            { text: "Ice and snow accident claims — winter falls on pavements, car parks and private land", href: "/public-place-accident-claims-scotland/ice-and-snow-accident-claims" },
            { text: "Occupiers' liability explained — the 1960 Act, reasonable care and warning signs", href: "/public-place-accident-claims-scotland/occupiers-liability-explained" },
          ],
        },
        {
      ...
      subpages={{
        ...
        pages: [
          ...
          { label: "Council Accident Claims", href: "/public-place-accident-claims-scotland/council-accident-claims", desc: "Parks, car parks, public roads" },
          { label: "Shop Accident Claims", href: "/shop-accident-claims-scotland", desc: "Retail premises injuries" },
          { label: "Restaurant Accident Claims", href: "/public-place-accident-claims-scotland/restaurant-pub-and-cafe-accident-claims", desc: "Cafés and food venues" },
          { label: "School Accident Claims", href: "/school-accident-claims-scotland", desc: "Children injured on school premises" },
          { label: "Sports Injury Claims", href: "/public-place-accident-claims-scotland/sports-and-leisure-injury-claims", desc: "Gyms, pools, leisure centres" },
          { label: "Ice and Snow Accident Claims", href: "/public-place-accident-claims-scotland/ice-and-snow-accident-claims", desc: "Winter falls and who is responsible" },
          { label: "Occupiers' Liability Explained", href: "/public-place-accident-claims-scotland/occupiers-liability-explained", desc: "The 1960 Act and reasonable care" },

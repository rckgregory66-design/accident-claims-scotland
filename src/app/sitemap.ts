...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages = [
    ...
    { url: `${SITE.url}/manual-handling-injury-claims-scotland`, changeFrequency: "monthly" as const, priority: 0.75 },
    { url: `${SITE.url}/needlestick-injury-claims-scotland`, changeFrequency: "monthly" as const, priority: 0.75 },
    { url: `${SITE.url}/stress-at-work-claims-scotland`, changeFrequency: "monthly" as const, priority: 0.75 },
    { url: `${SITE.url}/self-employed-injury-claims-scotland`, changeFrequency: "monthly" as const, priority: 0.75 },
    { url: `${SITE.url}/delayed-diagnosis-claims-scotland`, changeFrequency: "monthly" as const, priority: 0.75 },
    { url: `${SITE.url}/dental-negligence-claims-scotland`, changeFrequency: "monthly" as const, priority: 0.75 },
    { url: `${SITE.url}/hospital-infection-claims-scotland`, changeFrequency: "monthly" as const, priority: 0.75 },
    { url: `${SITE.url}/shop-accident-claims-scotland`, changeFrequency: "monthly" as const, priority: 0.75 },
    { url: `${SITE.url}/school-accident-claims-scotland`, changeFrequency: "monthly" as const, priority: 0.75 },
    { url: `${SITE.url}/hotel-accident-claims-scotland`, changeFrequency: "monthly" as const, priority: 0.75 },
    { url: `${SITE.url}/occupational-asthma-claims-scotland`, changeFrequency: "monthly" as const, priority: 0.75 },
    { url: `${SITE.url}/occupational-dermatitis-claims-scotland`, changeFrequency: "monthly" as const, priority: 0.75 },

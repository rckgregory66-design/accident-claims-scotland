...
const faqs = [
  ...
  { question: "Can I claim if my accident happened near Perth?", answer: "Potentially. The accident does not need to have happened in Perth city centre; eligibility depends on fault, causation, loss and the applicable time limit." },
...
export default function PerthPage() {
  return (
    <LocationPageTemplate
      ...
      intro="If you have been injured in Perth or the surrounding area and the accident was not your fault, you may be entitled to claim compensation. This page explains personal injury, medical negligence, workplace accident and industrial disease claims relevant to Perth residents."

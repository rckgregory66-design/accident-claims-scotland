    ...
    <ClaimPageTemplate
      ...
      sections={[
        ...
        },
        {
          ...
          linkedList: [
            ...
            { text: "Surgical negligence — errors during operations, wrong-site surgery, anaesthetic errors", href: "/medical-negligence-claims-scotland/surgical-negligence-claims" },
            { text: "Misdiagnosis and delayed diagnosis claims", href: "/medical-negligence-claims-scotland/misdiagnosis-claims" },
            ...
            { text: "Informed consent claims — the Montgomery test for material risks and alternatives", href: "/medical-negligence-claims-scotland/informed-consent-claims" },
            { text: "NHS complaints, the duty of candour and how they relate to a claim", href: "/medical-negligence-claims-scotland/nhs-complaints-and-duty-of-candour" },
            { text: "Fatal medical negligence claims", href: "/medical-negligence-claims-scotland/fatal-medical-negligence-claims" },
          ],
        },
        {
      ...
      subpages={{
        ...
        pages: [
          ...
          { label: "Hospital Negligence", href: "/medical-negligence-claims-scotland/hospital-negligence-claims", desc: "Surgical errors, post-operative care" },
          { label: "GP Negligence", href: "/gp-negligence-claims-scotland", desc: "Missed diagnosis, delayed referral" },
          { label: "Surgical Negligence", href: "/medical-negligence-claims-scotland/surgical-negligence-claims", desc: "Errors during operations" },
          { label: "Misdiagnosis Claims", href: "/medical-negligence-claims-scotland/misdiagnosis-claims", desc: "Wrong or delayed diagnosis" },
          ...
          { label: "Informed Consent Claims", href: "/medical-negligence-claims-scotland/informed-consent-claims", desc: "Material risks and the Montgomery test" },
          { label: "NHS Complaints and Duty of Candour", href: "/medical-negligence-claims-scotland/nhs-complaints-and-duty-of-candour", desc: "Complaints, apologies and claims" },
          { label: "Fatal Medical Negligence", href: "/medical-negligence-claims-scotland/fatal-medical-negligence-claims", desc: "Bereavement and dependency claims" },
        ],
      }}
